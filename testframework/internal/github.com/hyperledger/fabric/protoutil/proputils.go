...
func GetActionsFromEnvelope(envBytes []byte) ([]*peer.ChaincodeAction, error) {
	env, err := GetEnvelopeFromBlock(envBytes)
	if err != nil {
		return nil, err
	}
	return GetActionsFromEnvelopeMsg(env)
}

func GetActionsFromEnvelopeMsg(env *common.Envelope) ([]*peer.ChaincodeAction, error) {
