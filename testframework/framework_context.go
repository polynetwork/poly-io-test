...
func NewTestFrameworkContext(fw *TestFramework, caseArr []TestCase, rcSdk *poly_go_sdk.PolySdk, eInvkr *eth.EInvoker,
	btcInvkr *btc.BtcInvoker, ontInvkr *ont.OntInvoker, cmInvoker *cosmos.CosmosInvoker, neoInvoker *neo.NeoInvoker,
	fiscoInvoker *fisco.FiscoInvoker, fabricInvoker *fabric.FabricInvoker) *TestFrameworkContext {
	ctx := &TestFrameworkContext{
		...
		FiscoInvoker:  fiscoInvoker,
		FabricInvoker: fabricInvoker,
	}
