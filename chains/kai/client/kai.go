...
func (ec *Client) ChainID(ctx context.Context) (*big.Int, error) {
	...
	err := ec.c.CallContext(ctx, &result, "kai_chainId")
	if err != nil {
		return nil, err
	}
...
func (ec *Client) BlockByHash(ctx context.Context, hash common.Hash) (*ktypes.Block, error) {
...
// if you don't need all transactions or uncle headers.
func (ec *Client) BlockByNumber(ctx context.Context, number *big.Int) (*ktypes.Block, error) {
	return ec.getBlock(ctx, "kai_getBlockByNumber", toBlockNumArg(number), true)
}
...
func (ec *Client) getBlock(ctx context.Context, method string, args ...interface{}) (*ktypes.Block, error) {
	var raw ktypes.Block
...
func (ec *Client) HeaderByHash(ctx context.Context, hash common.Hash) (*types.Header, error) {
	...
	err := ec.c.CallContext(ctx, &head, "kai_getBlockByHash", hash, false)
	if err == nil && head == nil {
...
func (ec *Client) HeaderByNumber(ctx context.Context, number *big.Int) (*ktypes.Header, error) {
	...
	err := ec.c.CallContext(ctx, &head, "kai_getBlockByNumber", toBlockNumArg(number))
	if err == nil && head == nil {
		err = ethereum.NotFound
	}
	return head, err
...
func (ec *Client) TransactionSender(ctx context.Context, tx *types.Transaction, block common.Hash, index uint) (common.Address, error) {
	...
	if err = ec.c.CallContext(ctx, &meta, "kai_getTransactionByBlockHashAndIndex", block, hexutil.Uint64(index)); err != nil {
...
func (ec *Client) TransactionCount(ctx context.Context, blockHash common.Hash) (uint, error) {
	...
	err := ec.c.CallContext(ctx, &num, "kai_getBlockTransactionCountByHash", blockHash)
	return uint(num), err
}
...
func (ec *Client) SyncProgress(ctx context.Context) (*ethereum.SyncProgress, error) {
	...
	if err := ec.c.CallContext(ctx, &raw, "kai_syncing"); err != nil {
		return nil, err
	}
...
func (ec *Client) BalanceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "kai_getBalance", account, toBlockNumArg(blockNumber))
	return (*big.Int)(&result), err
}
...
func (ec *Client) StorageAt(ctx context.Context, account common.Address, key common.Hash, blockNumber *big.Int) ([]byte, error) {
	...
	err := ec.c.CallContext(ctx, &result, "kai_getStorageAt", account, key, toBlockNumArg(blockNumber))
	return result, err
}
...
func (ec *Client) CodeAt(ctx context.Context, account common.Address, blockNumber *big.Int) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "kai_getCode", account, toBlockNumArg(blockNumber))
	return result, err
}
...
func (ec *Client) PendingBalanceAt(ctx context.Context, account common.Address) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "kai_getBalance", account, "pending")
	return (*big.Int)(&result), err
}
...
func (ec *Client) PendingStorageAt(ctx context.Context, account common.Address, key common.Hash) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "kai_getStorageAt", account, key, "pending")
	return result, err
}
...
func (ec *Client) PendingCodeAt(ctx context.Context, account common.Address) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "kai_getCode", account, "pending")
	return result, err
}
...
func (ec *Client) PendingTransactionCount(ctx context.Context) (uint, error) {
	var num hexutil.Uint
	err := ec.c.CallContext(ctx, &num, "kai_getBlockTransactionCountByNumber", "pending")
	return uint(num), err
}
...
func (ec *Client) PendingCallContract(ctx context.Context, msg ethereum.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
	err := ec.c.CallContext(ctx, &hex, "kai_call", toCallArg(msg), "pending")
	if err != nil {
		return nil, err
	}
	return hex, nil
